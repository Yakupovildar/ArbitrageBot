...
⏰ Мониторинг автоматически запустится в рабочие часы (09:00-18:45 МСК, Пн-Пт)"""
            ...
            # ВРЕМЕННО ОТКЛЮЧЕН - остановим автозапуск тестового мониторинга
            await self.send_message(chat_id, """⚠️ ВАЖНАЯ ИНФОРМАЦИЯ О ТОРГАХ:

📊 Проверка показала что последние сделки на MOEX были в 06:59 утра
⏰ Сейчас 18:14 - прошло 12 часов без торгов

🔍 ВОЗМОЖНЫЕ ПРИЧИНЫ:
• Технический сбой на бирже
• Праздничный/выходной день  
• Приостановка торгов по решению MOEX

✅ СИСТЕМА РАБОТАЕТ ПРАВИЛЬНО - получает реальные данные
📈 Одинаковые цены объясняются остановкой торгов

🎯 Мониторинг возобновится когда MOEX вернется к работе""")
