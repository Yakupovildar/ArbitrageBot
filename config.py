    ...
    def __post_init__(self):
        ...
        if not self.MONITORED_INSTRUMENTS:
            self.MONITORED_INSTRUMENTS = {
                # ===== ОСНОВНЫЕ ГОЛУБЫЕ ФИШКИ (проверенные и рабочие пары) =====
                "SBER": "SBERF",  # Сбербанк - дневной фьючерс ✅ спред 0.38%
                "VTBR": "VBZ5",   # ВТБ - декабрь 2025 ✅ спред 6.46%  
                "FEES": "FSZ5",   # ФСК ЕЭС - декабрь 2025 ✅ спред 5.46%
                "GAZP": "GAZPF",  # Газпром - дневной фьючерс ⚠️ проверить
                "GMKN": "GKZ5",   # ГМК Норильский никель - декабрь 2025 ❌ неправильный масштаб
                "LKOH": "LKZ5",   # Лукойл - декабрь 2025 ❌ неправильный масштаб
                "ROSN": "RNZ5",   # Роснефть - декабрь 2025
                "TATN": "TTZ5",   # Татнефть - декабрь 2025
