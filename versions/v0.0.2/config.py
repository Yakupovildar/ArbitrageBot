...
class Config:
    ...
    def __post_init__(self):
        ...
        if not self.MONITORED_INSTRUMENTS:
            self.MONITORED_INSTRUMENTS = {
                ...
                # ===== РЕКОМЕНДОВАННЫЕ ПАРЫ (только работающие) =====
                "ABIO": "ISZ5",   # АВТОВАЗ ✅
                ...
                # Удалены несуществующие пары:
                # APTK/APZ5, BANEP/BEZ5, DIXY/DXZ5, DSKY/DSZ5, FIVE/FVZ5, FIXP/FXZ5
                # GEMC/GEZ5, HHRU/HRZ5, LSRG/LSZ5, MAIL/MLZ5, MSNG/MSZ5, OZON/OZZ5
                # PIKK/PKZ5, PLZL/PLZ5, PMSB/PMZ5, POLY/POZ5, PRTK/PRZ5, QIWI/QIZ5
                # RENI/REZ5, SMLT/SMZ5, TCSG/TCZ5, TRNFP/TRZ5, YAKG/YAZ5
            }
    ...
    def get_futures_lot_value(self, ticker: str) -> float:
        ...
        futures_multipliers = {
            ...
            # Z5 контракты с правильными мультипликаторами (на основе валидации)
            "ISZ5": 100,      # ABIO - 78.46₽ vs 8.38₽ => множитель ~10
            "AKZ5": 0.1,      # AFKS - 16.595₽ vs 174.62₽ => множитель 0.1  
            "AFZ5": 1,        # AFLT - 68.28₽ vs 71.55₽ => множитель 1
            "ANZ5": 600,      # AKRN - 16176₽ vs 26.72₽ => множитель ~600
            "ALZ5": 1,        # ALRS - правильный
            "BNZ5": 100,      # BANE - 1800₽ vs 18.72₽ => множитель ~100
            "BSZ5": 10,       # BSPB - 410.82₽ vs 40.74₽ => множитель ~10
            "CMZ5": 0.1,      # CBOM - 8.184₽ vs 86.07₽ => множитель 0.1
            "CHZ5": 1,        # CHMF - 1118₽ vs 1175₽ => множитель 1
            "ETZ5": 150,      # ETLN - 58₽ vs 0.3779₽ => множитель ~150
            "FSZ5": 0.001,    # FEES - 0.07372₽ vs 77.7₽ => множитель 0.001
            "FLZ5": 1,        # FLOT - 90.46₽ vs 95₽ => множитель 1
            "HYZ5": 0.01,     # HYDR - 0.4624₽ vs 49.08₽ => множитель 0.01
            "IRZ5": 0.01,     # IRAO - 3.292₽ vs 345.22₽ => множитель 0.01
            "KMZ5": 10,       # KMAZ - 95.4₽ vs 10.04₽ => множитель 10
            "MAZ5": 0.5,      # MAGN - 36.145₽ vs 69.65₽ => множитель 0.5
            "MGZ5": 10,       # MGNT - 3801.5₽ vs 372.12₽ => множитель 10
            "MEZ5": 1,        # MOEX - 186.73₽ vs 197.81₽ => множитель 1
            "MTZ5": 1,        # MTSS - 222.75₽ vs 235.24₽ => множитель 1
            "NKZ5": 0.07,     # NKNC - 88.05₽ vs 1293.73₽ => множитель 0.07
            "PHZ5": 100,      # PHOR - 7018₽ vs 70.84₽ => множитель 100
            "RAZ5": 10,       # RASP - 227.1₽ vs 24.12₽ => множитель 10
            "RTZ5": 1,        # RTKM - 69.4₽ vs 73.64₽ => множитель 1
            "RUZ5": 2.5,      # RUAL - 36.49₽ vs 13.8₽ => множитель 2.5
            "SZZ5": 0.1,      # SGZH - 1.609₽ vs 16.85₽ => множитель 0.1
            "SNZ5": 0.1,      # SNGS - 23.85₽ vs 249.94₽ => множитель 0.1
            "GKZ5": 1,        # GMKN - правильный
            "LKZ5": 1,        # LKOH - правильный
            "RNZ5": 1,        # ROSN - правильный
            "TNZ5": 1,        # TATN - правильный
            "VBZ5": 1,        # VTBR - правильный
        }
