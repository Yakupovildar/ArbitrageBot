...
✅ **КРИТИЧЕСКИЕ ИСПРАВЛЕНИЯ РАСЧЕТОВ И ИНТЕРФЕЙСА (ЗАВЕРШЕНО)**
- **Спред-расчеты ПОЛНОСТЬЮ ИСПРАВЛЕНЫ**: Найдена корневая причина - цены акций не учитывали размер лота
- **Правильный расчет**: Цена акции × размер лота = цена за лот (для сравнения с фьючерсами)
- **Пример FEES**: 0.07₽/шт × 10000 = 743₽/лот вместо 0.07₽ напрямую
